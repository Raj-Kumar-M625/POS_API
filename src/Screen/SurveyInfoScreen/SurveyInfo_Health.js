...
function SurveyInfo_Health() {
  ...
  return (
    <>
      <AdminNavbar data={{ Title: `${i18n.t("health")}` }}></AdminNavbar>
      <nav aria-label="breadcrumb" className="mx-3">
        {location.state.origin === "Surveyor" ? <ol className="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">{i18n.t('Dashboard2.health')}</li>
        </ol> :
          <ol class="breadcrumb">
...
export default SurveyInfo_Health;
