...
function SurveyInfo_Employment() {
  ...
  return (
    <>
      <AdminNavbar data={{ Title: `${i18n.t("employment")}` }}></AdminNavbar>
      <nav aria-label="breadcrumb" className="mx-3">
        {location.state.origin === "Surveyor" ? <ol className="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">{i18n.t('Dashboard2.employment')}</li>
        </ol> :
          <ol class="breadcrumb">
...
export default SurveyInfo_Employment;
