...
function SurveyInfo_Housing() {
  ...
  return (
    <>
      <AdminNavbar data={{ Title: `${i18n.t("housing")}` }}></AdminNavbar>
      <nav aria-label="breadcrumb" className="mx-3">
        {location.state.origin === "Surveyor" ? <ol className="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">{i18n.t('Dashboard2.housing')}</li>
        </ol> :
          <ol class="breadcrumb">
...
export default SurveyInfo_Housing;
