...
function SurveyInfo_Education() {
  ...
  return (
    <>
      <AdminNavbar data={{ Title: `${i18n.t("education")}` }}></AdminNavbar>
      <nav aria-label="breadcrumb" className="mx-3">
        {location.state.origin === "Surveyor" ? <ol className="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">{i18n.t('Dashboard2.education')}</li>
        </ol> :
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><Link to="/Admin/Dahsboard" className="textDecoration">{i18n.t('admin')}</Link></li>
...
export default SurveyInfo_Education;