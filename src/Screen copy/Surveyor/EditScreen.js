...
function EditScreen() {
  ...
  return (
    ...
    <Container fluid>
      <h5 style={{marginLeft:'50px'}}>UserManagement:Edit</h5>
          ...
          <div className="row g-3">
            ...
            <div className="col-md-6">
                <label>Date of Birth</label>
                     <input type="text" placeholder='22/5/1998' className="form-control" />
             </div>
            </div> 
            ...
            <div className="col-md-6">
                <label>Phone/Mobile Number</label>
                     <input type="text" placeholder='9985533720'  className="form-control" />
             </div>
            </div> 
