    ...
    RoleClaim, UserToken>
{
    ...
    public DbSet<TeamWeeklyObjective> TeamWeeklyObjective { get; set; }
    public DbSet<TeamMonthlyObjective> TeamMonthlyObjective { get; set; }
    public DbSet<ReleaseNotes> ReleaseNotes { get; set; }
    public DbSet<TaskReleaseNotes> TaskReleaseNotes { get; set; }
    public DbSet<UserTaskCheckList> UserTaskCheckList { get; set; }
    public DbSet<AppVersion> AppVersion { get; set; }
    public DbSet<WorkFlow> WorkFlow { get; set; }
    public DbSet<TaskTypeClassification> TaskTypeClassification { get; set; }
    ...
    public DbSet<ProjectObjectiveMapping> ProjectObjectiveMapping { get; set; }
    public DbSet<Document> Document { get; set; }
    public DbSet<EmployeeWorkFlow> EmployeeWorkFlow { get; set; }
    public DbSet<WorkFlowType> WorkFlowType { get; set; }
    public DbSet<PMOScrum> PMOScrum { get; set; }
    public DbSet<PayAttention> PayAttention { get; set; }
